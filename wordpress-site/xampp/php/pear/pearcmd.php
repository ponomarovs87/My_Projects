...
if ('C:\homework\JS_Lessons\wordpress-site\xampp\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('C:\homework\JS_Lessons\wordpress-site\xampp\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
