	...
	<form method="POST" action="https://analytics.wponlinesupport.com">
		<div class="wpos-anylc-optin-wrap" style="width: 650px; margin: 0 auto; margin-top: 70px;">
			...
			<div>
				...
				<div style="padding: 10px; background-color: #ff7b00;">
					<div style="margin-top:50px; margin-bottom: 30px; text-align: center; font-weight: 700; font-size: 24px; color: #fff;">Never miss an important update</div>

					<div style="font-size: 20px; color: #fff; font-weight: 500; line-height:25px; margin: 10px 12px; text-align:center;">Opt-in to get email notifications for security & feature updates, and to share some basic WordPress environment info. This will help us make the plugin more compatible with your site and better at doing what you need it to.</div>
				</div>
			</div>			
			...
			<div class="wpos-anylc-optin-permission" style="background-color: #ff7b00;">
