	...
	<div class="wpnw-deal-offer-wrap">
		<div class="wpnw-deal-offer"> 
			<div class="wpnw-inn-deal-offer">
				...
				<h4 class="wpnw-inn-deal-sub-hedding"><span style="color:red;">Extra Bonus: </span>Users will get <span>15% off</span> on the regular price using this coupon code.</h4>
			</div>
			<div class="wpnw-inn-deal-offer-btn">
				<div class="wpnw-inn-deal-code"><span>EPS15</span></div>
				<a href="<?php echo WPNW_PLUGIN_BUNDLE_LINK; ?>"  target="_blank" class="wpnw-sf-btn wpnw-sf-btn-orange"><span class="dashicons dashicons-cart"></span> Get Essential Bundle Now</a>
			</div>
		</div>
	</div>
